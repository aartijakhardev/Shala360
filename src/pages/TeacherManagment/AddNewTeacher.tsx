...
import { teacherAPI, TeacherFormData } from '@/lib/api';
import { 
  UserPlus, Upload, ArrowLeft, Save, Loader2, 
  User, MapPin, Phone, 
  BookOpen, FileText,
  Plus, X
} from 'lucide-react';
...
const AddNewTeacher = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: 'Success',
        description: `Teacher ${response.data.name} has been added successfully`
      });
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground">Create a comprehensive teacher profile</p>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Upload teacher's profile picture</CardDescription>
              </CardHeader>
              <CardContent>
              ...
              <CardContent>
                <div className="grid gap-4 md:grid-cols-2">
                  <div className="space-y-4">
                    <h4 className="font-semibold text-sm">Personal Contact</h4>
                    <div className="space-y-2">
